document.addEventListener('DOMContentLoaded', () => {
    ...
    const countDownDate = new Date("Oct 8, 2025 08:00:00").getTime();
        ...
        const countdownFunction = setInterval(function() {
            ...
            if (daysEl && hoursEl && minutesEl && secondsEl) {
                if (distance < 0) {
                    ...
                    countdownContainer.innerHTML = "<div class='page-subtitle' style='margin:0;'>The Event Is Live!</div>";
                } else {
    ...
    // --- 4. Event Rules Fade/Flip Logic (FIXED) ---
